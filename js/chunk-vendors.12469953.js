 ...
 * limitations under the License.
 */
async function xt(t,e){return U(t,"POST","/v1/accounts:signInWithPassword",L(t,e))}async function Nt(t,e){return P(t,"POST","/v1/accounts:sendOobCode",L(t,e))}async function Rt(t,e){return Nt(t,e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const kn=6e5;class Cn{constructor(t){this.auth=t,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(t){this.consumers.add(t),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,t)&&(this.sendToConsumer(this.queuedRedirectEvent,t),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(t){this.consumers.delete(t)}onEvent(t){if(this.hasEventBeenHandled(t))return!1;let e=!1;return this.consumers.forEach((n=>{this.isEventForConsumer(t,n)&&(e=!0,this.sendToConsumer(t,n),this.saveEventToCache(t))})),this.hasHandledPotentialRedirect||!xn(t)||(this.hasHandledPotentialRedirect=!0,e||(this.queuedRedirectEvent=t,e=!0)),e}sendToConsumer(t,e){var n;if(t.error&&!On(t)){const r=(null===(n=t.error.code)||void 0===n?void 0:n.split("auth/")[1])||"internal-error";e.onError(p(this.auth,r))}else e.onAuthEvent(t)}isEventForConsumer(t,e){const n=null===e.eventId||!!t.eventId&&t.eventId===e.eventId;return e.filter.includes(t.type)&&n}hasEventBeenHandled(t){return Date.now()-this.lastProcessedEventTime>=kn&&this.cachedEventUids.clear(),this.cachedEventUids.has(Sn(t))}saveEventToCache(t){this.cachedEventUids.add(Sn(t)),this.lastProcessedEventTime=Date.now()}}function Sn(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter((t=>t)).join("-")}function On({type:t,error:e}){return"unknown"===t&&"auth/no-auth-event"===(null===e||void 0===e?void 0:e.code)}function xn(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return On(t);default:return!1}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class El{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Il(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new El(this.firestore,t,this._key)}}class Tl{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new Tl(this.firestore,t,this._query)}}class Il extends Tl{constructor(t,e,n){super(t,e,js(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new El(this.firestore,null,new vi(t))}withConverter(t){return new Il(this.firestore,t,this._path)}}function Al(t,e,...n){if(t=(0,a.m9)(t),pl("collection","path",e),t instanceof wl){const r=pi.fromString(e,...n);return vl(r),new Il(t,null,r)}{if(!(t instanceof El||t instanceof Il))throw new Yr(Jr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(pi.fromString(e,...n));return vl(r),new Il(t.firestore,null,r)}}function kl(t,e,...n){if(t=(0,a.m9)(t),1===arguments.length&&(e=ci.I()),pl("doc","path",e),t instanceof wl){const r=pi.fromString(e,...n);return gl(r),new El(t,null,new vi(r))}{if(!(t instanceof El||t instanceof Il))throw new Yr(Jr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(pi.fromString(e,...n));return gl(r),new El(t.firestore,t instanceof Il?t.converter:null,new vi(r))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ih(t){t=_l(t,El);const e=_l(t.firestore,Ol);return dl(Nl(e),t._key).then((n=>xh(e,t,n)))}class Ah extends Eh{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ll(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new El(this.firestore,null,e)}}function kh(t,e,n,...r){t=_l(t,El);const i=_l(t.firestore,Ol),s=ql(i);let o;return o="string"==typeof(e=(0,a.m9)(e))||e instanceof Dl?Kl(s,"updateDoc",t._key,e,n,r):Wl(s,"updateDoc",t._key,e),Oh(i,[o.toMutation(t._key,vo.exists(!0))])}function Ch(t,e){const n=_l(t.firestore,Ol),r=kl(t),i=Th(t.converter,e);return Oh(n,[Hl(ql(t.firestore),"addDoc",r._key,i,null!==t.converter,{}).toMutation(r._key,vo.exists(!1))]).then((()=>r))}function Sh(t,...e){var n,r,i;t=(0,a.m9)(t);let s={includeMetadataChanges:!1},o=0;"object"!=typeof e[o]||Sl(e[o])||(s=e[o],o++);const c={includeMetadataChanges:s.includeMetadataChanges};if(Sl(e[o])){const t=e[o];e[o]=null===(n=t.next)||void 0===n?void 0:n.bind(t),e[o+1]=null===(r=t.error)||void 0===r?void 0:r.bind(t),e[o+2]=null===(i=t.complete)||void 0===i?void 0:i.bind(t)}let u,l,h;if(t instanceof El)l=_l(t.firestore,Ol),h=js(t._key.path),u={next:n=>{e[o]&&e[o](xh(l,t,n))},error:e[o+1],complete:e[o+2]};else{const n=_l(t,Tl);l=_l(n.firestore,Ol),h=n._query;const r=new Ah(l);u={next:t=>{e[o]&&e[o](new lh(l,r,n,t))},error:e[o+1],complete:e[o+2]},dh(t._query)}return function(t,e,n,r){const i=new il(r),s=new Su(e,i,n);return t.asyncQueue.enqueueAndForget((async()=>Tu(await hl(t),s))),()=>{i.Tc(),t.asyncQueue.enqueueAndForget((async()=>Iu(await hl(t),s)))}}(Nl(l),h,c,u)}function Oh(t,e){return function(t,e){const n=new Zr;return t.asyncQueue.enqueueAndForget((async()=>ju(await ll(t),e,n))),n.promise}(Nl(t),e)}function xh(t,e,n){const r=n.docs.get(e._key),i=new Ah(t);return new ch(t,i,e._key,r,new ah(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class $t{constructor(t,e){this._service=t,this._location=e instanceof x?e:x.makeFromUrl(e,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,e){return new $t(t,e)}get root(){const t=new x(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return pt(this._location.path)}get storage(){return this._service}get parent(){const t=dt(this._location.path);if(null===t)return null;const e=new x(this._location.bucket,t);return new $t(this._service,e)}_throwIfRoot(t){if(""===this._location.path)throw C(t)}}function Ft(t,e,n){t._throwIfRoot("uploadBytes");const r=Lt(t.storage,t._location,_t(),new lt(e,!0),n);return t.storage.makeRequestWithTokens(r,jt).then((e=>({metadata:e,ref:t})))}function Vt(t){t._throwIfRoot("getDownloadURL");const e=Nt(t.storage,t._location,_t());return t.storage.makeRequestWithTokens(e,jt).then((t=>{if(null===t)throw I();return t}))}function Bt(t,e){const n=ft(t._location.path,e),r=new x(t._location.bucket,n);return new $t(t.storage,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.12469953.js.map